  ...
  const DICTS = {
    ru: {
      ...
      settings: {
        ...
        t_gigaam_rnnt: 'GigaAM v3 RNN-T — самый точный для русского',
        t_gigaam: 'GigaAM v3 CTC — точный, быстрее RNN-T',
        ...
        preload_gigaam_rnnt: 'Предзагрузка GigaAM RNN-T',
        preload_gigaam: 'Предзагрузка GigaAM CTC',
      ...
      update: {
        ...
        toast_restart_failed: 'Не удалось перезапустить: {err}',
    ...
    en: {
      ...
      settings: {
        ...
        t_gigaam_rnnt: 'GigaAM v3 RNN-T — most accurate for Russian',
        t_gigaam: 'GigaAM v3 CTC — accurate, faster than RNN-T',
        ...
        preload_gigaam_rnnt: 'Preload GigaAM RNN-T',
        preload_gigaam: 'Preload GigaAM CTC',
      ...
      update: {
        ...
        toast_restart_failed: 'Restart failed: {err}',
