...
**v1.0.0** с четырьмя STT-движками:
...
1. **macOS** — Phase 10.2 (Tauri v2 уже поддерживает macOS)
2. **Windows** — Phase 10.3
3. **Streaming partial results** — Phase 8 (GigaAM RNNT)
4. **Flatpak / Snap** — Phase 10.4
